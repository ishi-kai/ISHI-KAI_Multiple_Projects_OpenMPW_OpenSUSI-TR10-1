...
N 1190 10 1210 10 {lab=P15}
N 1210 -60 1210 10 {lab=P15}
N 1190 -10 1200 -10 {lab=DBODY}
N 1200 -10 1200 80 {lab=DBODY}
N 940 -50 1120 -50 {lab=VDD}
N 940 50 1120 50 {lab=#net1}
N 1050 10 1050 60 {lab=#net2}
N 870 60 1050 60 {lab=#net2}
N 1040 -10 1050 -10 {lab=#net3}
N 1040 -10 1040 70 {lab=#net3}
N 860 70 1040 70 {lab=#net3}
N 0 0 0 70 {lab=#net4}
...
C {TG.sym} 1120 10 0 0 {name=x7}
C {devices/iopin.sym} 1200 80 0 0 {name=p1 lab=DBODY}
C {devices/iopin.sym} 1210 -60 0 0 {name=p3 lab=P15}
C {devices/iopin.sym} -130 -60 0 1 {name=p14 lab=VDD}
C {devices/iopin.sym} -130 60 0 1 {name=p15 lab=VSS}
C {TR-1um_5_stdcell/NOR2.sym} -110 0 0 0 {name=x8}
C {devices/iopin.sym} -130 -20 0 1 {name=p16 lab=HG}
C {devices/iopin.sym} -130 20 0 1 {name=p17 lab=LN}
