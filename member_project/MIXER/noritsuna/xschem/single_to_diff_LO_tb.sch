...
N -130 -140 -50 -140 {lab=LO_IN}
N 210 180 210 200 {lab=GND}
N 210 80 210 120 {lab=LO_IN}
...
write single_to_diff_LO_tb.raw
.endc"}
C {single_to_diff_LO.sym} 240 -110 0 0 {name=x1}
...
C {devices/lab_pin.sym} -130 -140 0 0 {name=l4 sig_type=std_logic lab=LO_IN
}
C {devices/lab_pin.sym} 390 -120 0 1 {name=l2 sig_type=std_logic lab=LO_N
}
C {devices/lab_pin.sym} 390 -100 0 1 {name=l5 sig_type=std_logic lab=LO_P
}
C {devices/lab_pin.sym} 390 -140 0 1 {name=l6 sig_type=std_logic lab=VDD
}
C {devices/vsource.sym} 210 150 0 0 {name=V1 value="SIN(0 200m 1049k)" savecurrent=false}
C {devices/lab_pin.sym} 210 80 0 1 {name=l12 sig_type=std_logic lab=LO_IN
}
