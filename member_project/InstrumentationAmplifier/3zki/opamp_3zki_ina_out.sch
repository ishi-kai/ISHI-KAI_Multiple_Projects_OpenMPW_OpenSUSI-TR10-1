...
T {Typical Cascode Opamp Rev.6 halfsize
...
T {VB=2.5V} -660 -720 0 0 0.4 0.4 {}
T {14.0 is NOT a typo} 2560 -720 0 0 0.4 0.4 {}
...
N 880 -660 880 -540 {lab=#net6}
N 1120 -660 1120 -540 {lab=#net7}
...
N 140 -300 140 -180 {lab=#net8}
N 0 -300 0 -180 {lab=#net9}
...
N -420 -480 -420 -360 {lab=#net10}
N -300 -330 -280 -330 {lab=VSS}
N -280 -300 -280 -180 {lab=#net11}
N -420 -300 -420 -180 {lab=#net12}
...
N 1000 -620 1000 -540 {lab=#net13}
N 1000 -480 1000 -360 {lab=#net14}
N 1000 -300 1000 -180 {lab=#net15}
...
N 280 -480 280 -360 {lab=#net17}
N 260 -330 280 -330 {lab=VSS}
N 280 -300 280 -180 {lab=#net18}
N 280 -120 280 0 {lab=VSS}
...
N 1320 -620 1320 -540 {lab=#net22}
N 1320 -480 1320 -360 {lab=#net14}
N 1320 -300 1320 -180 {lab=#net15}
...
N 1840 -1050 1880 -1050 {lab=#net23}
N 1840 -870 1880 -870 {lab=BPI}
N 1720 -690 1880 -690 {lab=BPF}
N 1560 -1200 1920 -1200 {lab=VDD}
N 1760 -1050 1840 -1050 {lab=#net23}
N 1760 -870 1840 -870 {lab=BPI}
N 1680 -300 1680 -180 {lab=#net7}
...
N 1740 -1050 1740 -540 {lab=#net23}
N 1680 -820 1740 -820 {lab=#net23}
N 1680 -460 1740 -460 {lab=#net25}
N 1740 -480 1740 -150 {lab=#net25}
N 1720 -150 1740 -150 {lab=#net25}
N 1920 -300 1920 -180 {lab=#net6}
...
N 1860 -460 1920 -460 {lab=#net26}
N 1740 -150 1880 -150 {lab=#net25}
N 1720 -330 1880 -330 {lab=BNI}
N 1120 -280 1680 -280 {lab=#net7}
N 880 -540 880 -260 {lab=#net6}
N 880 -260 1920 -260 {lab=#net6}
N 1680 0 1940 0 {lab=VSS}
N 1860 -480 1860 -460 {lab=#net26}
N 1860 -820 1860 -540 {lab=#net24}
N 1860 -820 1910 -820 {lab=#net24}
N 1910 -820 1920 -820 {lab=#net24}
N 1010 -980 1920 -980 {lab=#net13}
N 1320 -960 1680 -960 {lab=#net22}
N 1160 -690 1400 -690 {lab=INM}
N 1320 -960 1320 -620 {lab=#net22}
N 1000 -980 1010 -980 {lab=#net13}
N 1000 -980 1000 -620 {lab=#net13}
...
N 2760 -780 2760 -690 {lab=#net24}
N 2520 -780 2760 -780 {lab=#net24}
N 2760 -490 2760 -420 {lab=#net26}
N 2800 -480 2800 -460 {lab=VSS}
N 2760 -510 2760 -490 {lab=#net26}
...
N 2650 -650 2720 -650 {lab=#net13}
N 2650 -530 2720 -530 {lab=#net6}
N 2480 -650 2650 -650 {lab=#net13}
N 2480 -530 2650 -530 {lab=#net6}
N 2180 -920 2180 -650 {lab=#net13}
N 2180 -530 2180 -200 {lab=#net6}
N 2180 -530 2410 -530 {lab=#net6}
N 2470 -530 2480 -530 {lab=#net6}
N 2470 -650 2480 -650 {lab=#net13}
N 2180 -650 2410 -650 {lab=#net13}
...
N 2520 -420 2760 -420 {lab=#net26}
N 1600 -1200 1600 -690 {lab=VDD}
N 1480 -1200 1560 -1200 {lab=VDD}
N 1540 -690 1560 -690 {lab=VDD}
N 1540 -1200 1540 -690 {lab=VDD}
N 1560 -660 1680 -660 {lab=#net25}
N 1920 -660 2040 -660 {lab=#net26}
N 1920 -780 2520 -780 {lab=#net24}
N 1920 -920 2180 -920 {lab=#net13}
N 2040 -690 2060 -690 {lab=VDD}
N 2060 -1200 2060 -690 {lab=VDD}
N 2000 -1200 2000 -690 {lab=VDD}
N 1560 -540 1740 -540 {lab=#net23}
N 1560 -480 1730 -480 {lab=#net25}
N 1860 -480 2040 -480 {lab=#net26}
N 1920 -660 1920 -360 {lab=#net26}
N 1680 -660 1680 -360 {lab=#net25}
N 1860 -540 2040 -540 {lab=#net24}
N 2000 -510 2000 0 {lab=VSS}
N 1940 0 2000 0 {lab=VSS}
N 1940 0 2080 -0 {lab=VSS}
N 1920 -420 2520 -420 {lab=#net26}
N 1920 -200 2180 -200 {lab=#net6}
N 2040 -510 2060 -510 {lab=VSS}
N 2060 -510 2060 0 {lab=VSS}
N 1540 -510 1560 -510 {lab=VSS}
N 1540 -510 1540 -0 {lab=VSS}
N 1920 -720 2040 -720 {lab=#net24}
N 1560 -720 1680 -720 {lab=#net23}
N 1730 -480 1740 -480 {lab=#net25}
N 1600 -510 1600 -0 {lab=VSS}
N 1000 -360 1320 -360 {lab=#net14}
N 460 -1050 480 -1050 {lab=#net21}
N 480 -1050 480 -840 {lab=#net21}
N 420 -840 480 -840 {lab=#net21}
N 320 -150 340 -150 {lab=#net17}
N 340 -360 340 -150 {lab=#net17}
N 280 -360 340 -360 {lab=#net17}
N 1120 -540 1120 -280 {lab=#net7}
N 2410 -530 2470 -530 {lab=#net6}
N 2410 -650 2470 -650 {lab=#net13}
N 2340 -1200 2680 -1200 {lab=VDD}
N 2340 -0 2580 -0 {lab=VSS}
N 880 -1020 1120 -1020 {lab=#net4}
N 1000 -180 1320 -180 {lab=#net15}
N -720 -130 -700 -130 {lab=VSS}
N -720 -130 -720 -80 {lab=VSS}
N -720 -80 -660 -80 {lab=VSS}
N -660 -100 -660 -80 {lab=VSS}
N -660 -160 -640 -160 {lab=VSS}
N -640 -160 -640 -130 {lab=VSS}
N -660 -130 -640 -130 {lab=VSS}
N -640 -130 -640 -80 {lab=VSS}
N -660 -80 -640 -80 {lab=VSS}
N -660 -220 -640 -220 {lab=VDD}
N -660 -250 -640 -250 {lab=VDD}
N -720 -250 -700 -250 {lab=VDD}
N -720 -300 -720 -250 {lab=VDD}
N -720 -300 -660 -300 {lab=VDD}
N -660 -300 -660 -280 {lab=VDD}
N -660 -300 -640 -300 {lab=VDD}
N -640 -300 -640 -220 {lab=VDD}
...
C {IP62LIB/MP.sym} 180 -1050 0 1 {name=XMB4P1 model=PMOS w=13.2u l=5u m=2 as=19.8p ad=19.8p ps=16.2u pd=16.2u nrd=0 nrs=0}
C {IP62LIB/MP.sym} 180 -870 0 1 {name=XMB4P2 model=PMOS w=13.2u l=5u m=2 as=19.8p ad=19.8p ps=16.2u pd=16.2u nrd=0 nrs=0}
C {IP62LIB/MP.sym} 40 -1050 0 1 {name=XMB3P1 model=PMOS w=13.2u l=5u m=1 as=19.8p ad=19.8p ps=16.2u pd=16.2u nrd=0 nrs=0}
C {IP62LIB/MP.sym} 40 -870 0 1 {name=XMB3P2 model=PMOS w=13.2u l=5u m=1 as=19.8p ad=19.8p ps=16.2u pd=16.2u nrd=0 nrs=0}
C {IP62LIB/MP.sym} 40 -690 0 1 {name=XMB3P3 model=PMOS w=13.2u l=5u m=1 as=19.8p ad=19.8p ps=16.2u pd=16.2u nrd=0 nrs=0}
...
C {IP62LIB/MP.sym} 840 -1050 0 0 {name=XMINPP1 model=PMOS w=13.2u l=5u m=4 as=20.4p ad=20.4p ps=16.6u pd=16.6u nrd=0 nrs=0}
C {IP62LIB/MP.sym} 840 -870 0 0 {name=XMINPP2 model=PMOS w=13.2u l=5u m=4 as=20.4p ad=20.4p ps=16.6u pd=16.6u nrd=0 nrs=0}
C {IP62LIB/MP.sym} 840 -690 0 0 {name=XMINPP3 model=PMOS w=13.2u l=5u m=4 as=20.4p ad=20.4p ps=16.6u pd=16.6u nrd=0 nrs=0}
...
C {IP62LIB/MP.sym} 1160 -1050 0 1 {name=XMINMP1 model=PMOS w=13.2u l=5u m=4 as=20.4p ad=20.4p ps=16.6u pd=16.6u nrd=0 nrs=0}
C {IP62LIB/MP.sym} 1160 -870 0 1 {name=XMINMP2 model=PMOS w=13.2u l=5u m=4 as=20.4p ad=20.4p ps=16.6u pd=16.6u nrd=0 nrs=0}
C {IP62LIB/MP.sym} 1160 -690 0 1 {name=XMINMP3 model=PMOS w=13.2u l=5u m=4 as=20.4p ad=20.4p ps=16.6u pd=16.6u nrd=0 nrs=0}
...
m=4
w=13.2u}
C {IP62LIB/MN.sym} 180 -330 0 1 {name=XMB4N2 model=NMOS w=4.8u l=5u m=2 as=7.2p ad=7.2p ps=7.8u pd=7.8u nrd=0 nrs=0}
C {IP62LIB/MN.sym} 40 -330 0 1 {name=XMB3N2 model=NMOS w=4.8u l=5u m=2 as=7.2p ad=7.2p ps=7.8u pd=7.8u nrd=0 nrs=0}
C {IP62LIB/MN.sym} 180 -150 0 1 {name=XMB4N1 model=NMOS w=4.8u l=5u m=2 as=7.2p ad=7.2p ps=7.8u pd=7.8u nrd=0 nrs=0}
C {IP62LIB/MN.sym} 40 -150 0 1 {name=XMB3N1 model=NMOS w=4.8u l=5u m=2 as=7.2p ad=7.2p ps=7.8u pd=7.8u nrd=0 nrs=0}
C {IP62LIB/MN.sym} -240 -330 0 1 {name=XMB1N2 model=NMOS w=4.8u l=5u m=2 as=7.2p ad=7.2p ps=7.8u pd=7.8u nrd=0 nrs=0}
C {IP62LIB/MN.sym} -380 -330 0 1 {name=XMB2N2 model=NMOS w=4.8u l=5u m=1 as=7.2p ad=7.2p ps=7.8u pd=7.8u nrd=0 nrs=0}
C {IP62LIB/MN.sym} -240 -150 0 1 {name=XMB1N1 model=NMOS w=4.8u l=5u m=2 as=7.2p ad=7.2p ps=7.8u pd=7.8u nrd=0 nrs=0}
C {IP62LIB/MN.sym} -380 -150 0 1 {name=XMB2N1 model=NMOS w=4.8u l=5u m=1 as=7.2p ad=7.2p ps=7.8u pd=7.8u nrd=0 nrs=0}
C {IP62LIB/MN.sym} -380 -510 0 1 {name=XMB2N3 model=NMOS w=4.8u l=5u m=1 as=7.2p ad=7.2p ps=7.8u pd=7.8u nrd=0 nrs=0}
...
C {IP62LIB/MN.sym} 960 -330 0 0 {name=XMINPN2 model=NMOS w=4.8u l=5u m=4 as=7.2p ad=7.2p ps=7.8u pd=7.8u nrd=0 nrs=0}
C {IP62LIB/MN.sym} 960 -150 0 0 {name=XMINPN1 model=NMOS w=4.8u l=5u m=4 as=7.2p ad=7.2p ps=7.8u pd=7.8u nrd=0 nrs=0}
C {IP62LIB/MN.sym} 960 -510 0 0 {name=XMINPN3 model=NMOS w=4.8u l=5u m=4 as=7.2p ad=7.2p ps=7.8u pd=7.8u nrd=0 nrs=0}
...
m=4}
C {IP62LIB/MP.sym} 320 -1050 0 1 {name=XMB5P1 model=PMOS w=13.2u l=5u m=2 as=19.8p ad=19.8p ps=16.2u pd=16.2u nrd=0 nrs=0}
C {IP62LIB/MP.sym} 320 -870 0 1 {name=XMB5P2 model=PMOS w=13.2u l=5u m=2 as=19.8p ad=19.8p ps=16.2u pd=16.2u nrd=0 nrs=0}
C {IP62LIB/MN.sym} 320 -330 0 1 {name=XMB5N2 model=NMOS w=4.8u l=5u m=2 as=7.2p ad=7.2p ps=7.8u pd=7.8u nrd=0 nrs=0}
C {IP62LIB/MN.sym} 320 -150 0 1 {name=XMB5N1 model=NMOS w=4.8u l=5u m=2 as=7.2p ad=7.2p ps=7.8u pd=7.8u nrd=0 nrs=0}
C {IP62LIB/MN.sym} 320 -510 0 1 {name=XMB5N3 model=NMOS w=4.8u l=5u m=2 as=7.2p ad=7.2p ps=7.8u pd=7.8u nrd=0 nrs=0}
C {devices/lab_wire.sym} 720 -380 0 0 {name=p12 sig_type=std_logic lab=BNF}
C {IP62LIB/MP.sym} 460 -1050 0 1 {name=XMB6P1 model=PMOS w=13.2u l=5u m=2 as=19.8p ad=19.8p ps=16.2u pd=16.2u nrd=0 nrs=0}
C {IP62LIB/MP.sym} 460 -870 0 1 {name=XMB6P2 model=PMOS w=13.2u l=5u m=2 as=19.8p ad=19.8p ps=16.2u pd=16.2u nrd=0 nrs=0}
C {IP62LIB/MN.sym} 460 -330 0 1 {name=XMB6N2 model=NMOS w=4.8u l=5u m=2 as=7.2p ad=7.2p ps=7.8u pd=7.8u nrd=0 nrs=0}
C {IP62LIB/MN.sym} 460 -150 0 1 {name=XMB6N1 model=NMOS w=4.8u l=5u m=2 as=7.2p ad=7.2p ps=7.8u pd=7.8u nrd=0 nrs=0}
C {IP62LIB/MP.sym} 460 -690 0 1 {name=XMB6P3 model=PMOS w=13.2u l=5u m=2 as=19.8p ad=19.8p ps=16.2u pd=16.2u nrd=0 nrs=0}
C {devices/lab_wire.sym} 720 -820 0 0 {name=p15 sig_type=std_logic lab=BPF}
C {IP62LIB/MN.sym} -520 -510 0 1 {name=XMB2DMYN model=NMOS w=4.8u l=5u m=1 as=7.2p ad=7.2p ps=7.8u pd=7.8u nrd=0 nrs=0}
C {IP62LIB/MN.sym} 1360 -330 0 1 {name=XMINMN2 model=NMOS w=4.8u l=5u m=4 as=7.2p ad=7.2p ps=7.8u pd=7.8u nrd=0 nrs=0}
C {IP62LIB/MN.sym} 1360 -150 0 1 {name=XMINMN1 model=NMOS w=4.8u l=5u m=4 as=7.2p ad=7.2p ps=7.8u pd=7.8u nrd=0 nrs=0}
C {IP62LIB/MN.sym} 1360 -510 0 1 {name=XMINMN3 model=NMOS w=4.8u l=5u m=4 as=7.2p ad=7.2p ps=7.8u pd=7.8u nrd=0 nrs=0}
...
m=4}
C {IP62LIB/MP.sym} 1720 -1050 0 1 {name=XMCSMP1 model=PMOS w=13.2u l=5u m=8 as=19.8p ad=19.8p ps=16.2u pd=16.2u nrd=0 nrs=0}
C {IP62LIB/MP.sym} 1720 -870 0 1 {name=XMCSMP2 model=PMOS w=13.2u l=5u m=4 as=19.8p ad=19.8p ps=16.2u pd=16.2u nrd=0 nrs=0}
C {IP62LIB/MP.sym} 1720 -690 0 1 {name=XMCSMP3 model=PMOS w=13.2u l=5u m=2 as=19.8p ad=19.8p ps=16.2u pd=16.2u nrd=0 nrs=0}
C {IP62LIB/MP.sym} 1880 -1050 0 0 {name=XMCSPP1 model=PMOS w=13.2u l=5u m=8 as=19.8p ad=19.8p ps=16.2u pd=16.2u nrd=0 nrs=0}
C {IP62LIB/MP.sym} 1880 -870 0 0 {name=XMCSPP2 model=PMOS w=13.2u l=5u m=4 as=19.8p ad=19.8p ps=16.2u pd=16.2u nrd=0 nrs=0}
C {IP62LIB/MP.sym} 1880 -690 0 0 {name=XMCSPP3 model=PMOS w=13.2u l=5u m=2 as=19.8p ad=19.8p ps=16.2u pd=16.2u nrd=0 nrs=0}
...
ps=16.2u
pd=16.2u}
C {IP62LIB/MN.sym} 1720 -330 0 1 {name=XMCSMN2 model=NMOS w=4.8u l=5u m=4 as=7.2p ad=7.2p ps=7.8u pd=7.8u nrd=0 nrs=0}
C {IP62LIB/MN.sym} 1720 -150 0 1 {name=XMCSMN1 model=NMOS w=4.8u l=5u m=8 as=7.2p ad=7.2p ps=7.8u pd=7.8u nrd=0 nrs=0}
C {IP62LIB/MN.sym} 1780 -510 0 1 {name=XMCSMN3 model=NMOS w=4.8u l=5u m=2 as=7.2p ad=7.2p ps=7.8u pd=7.8u nrd=0 nrs=0}
C {IP62LIB/MN.sym} 1820 -510 0 0 {name=XMCSPN3 model=NMOS w=4.8u l=5u m=2 as=7.2p ad=7.2p ps=7.8u pd=7.8u nrd=0 nrs=0}
C {IP62LIB/MN.sym} 1880 -330 0 0 {name=XMCSPN2 model=NMOS w=4.8u l=5u m=4 as=7.2p ad=7.2p ps=7.8u pd=7.8u nrd=0 nrs=0}
C {IP62LIB/MN.sym} 1880 -150 0 0 {name=XMCSPN1 model=NMOS w=4.8u l=5u m=8 as=7.2p ad=7.2p ps=7.8u pd=7.8u nrd=0 nrs=0}
...
C {IP62LIB/MP.sym} -380 -890 0 1 {name=XMPVB1 model=PMOS w=13.2u l=5u m=2 as=19.8p ad=19.8p ps=16.2u pd=16.2u nrd=0 nrs=0}
C {IP62LIB/MP.sym} -320 -890 0 0 {name=XMPVB2 model=PMOS w=13.2u l=5u m=2 as=19.8p ad=19.8p ps=16.2u pd=16.2u nrd=0 nrs=0}
C {devices/ipin.sym} -520 -780 0 0 {name=p11 lab=VB}
C {IP62LIB/MP.sym} -100 -690 0 1 {name=XMDMYP4 model=PMOS w=13.2u l=5u m=1 as=19.8p ad=19.8p ps=16.2u pd=16.2u nrd=0 nrs=0
}
C {IP62LIB/MP.sym} 1600 -690 0 1 {name=XMCSMDMYP model=PMOS w=13.2u l=5u m=2 as=19.8p ad=19.8p ps=16.2u pd=16.2u nrd=0 nrs=0}
C {IP62LIB/MP.sym} 2000 -690 0 0 {name=XMCSPDMYP model=PMOS w=13.2u l=5u m=2 as=19.8p ad=19.8p ps=16.2u pd=16.2u nrd=0 nrs=0}
C {IP62LIB/MN.sym} 1600 -510 0 1 {name=XMCSMDMYN model=NMOS w=4.8u l=5u m=2 as=7.2p ad=7.2p ps=7.8u pd=7.8u nrd=0 nrs=0}
C {IP62LIB/MN.sym} 2000 -510 0 0 {name=XMCSPDMYN model=NMOS w=4.8u l=5u m=2 as=7.2p ad=7.2p ps=7.8u pd=7.8u nrd=0 nrs=0}
C {IP62LIB/MN.sym} -700 -130 0 0 {name=XMDMYN1 model=NMOS w=4.8u l=5u m=4 as=7.2p ad=7.2p ps=7.8u pd=7.8u nrd=0 nrs=0}
C {devices/lab_wire.sym} -720 -80 0 0 {name=p26 sig_type=std_logic lab=VSS}
C {IP62LIB/MP.sym} -700 -250 0 0 {name=XMDMYP1 model=PMOS w=13.2u l=5u m=8 as=19.8p ad=19.8p ps=16.2u pd=16.2u nrd=0 nrs=0}
C {devices/lab_wire.sym} -720 -300 0 0 {name=p10 sig_type=std_logic lab=VDD}
