...
F {}
E {}
T {2 x 2 SRAM | STANDARD-CELL ROW DECODER / MUX / SENSE} -180 -270 0 0 0.45 0.45 {}
...
T {IDEAL CONTROLS: edit PWL sources with q (RA / WL_EN drive real row decoder; other controls ideal)} -120 1830 0 0 0.3 0.3 {}
...
if failures = 0
 echo PASS: row decoder selection, mux writes, sensed reads, reset and retention
else
 echo FAIL: inspect measurements
 print failures
end
write sram_tb_array_row_decoder.raw
