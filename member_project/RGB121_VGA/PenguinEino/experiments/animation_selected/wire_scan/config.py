...
STA_EXTRA_TCL = None
ANIMATION = {'mode': 'wire_scan', 'phase_bits': 6, 'phase_enable': 'h==100 && v==0', 'clock_hz': 3150000, 'frame_hz': 60, 'cycle_frames': 64, 'source': 'designs/grid_power', 'adopted': False, 'flow_scope': 'synthesis and digital simulation only'}
finalize(globals())
