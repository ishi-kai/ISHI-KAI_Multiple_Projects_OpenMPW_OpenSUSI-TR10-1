...
# Reproducible inputs/default coordinates for the isolated metal-only trials.
# The repair script reads this literal dictionary from config.py via AST so it
# can use these settings without executing APRtools' config finalizer.
METAL_REPAIR_SETTINGS = {
    'input_gds': 'build/postrepair_compacted.gds',
    'actual_pin_map': 'build/actual_pin_map.json',
    'input_net_shapes': 'build/postrepair_shapes.json',
    'junction': {
        'track_y_um': 729.6,
    },
    'repair_040': {
        'base_gds': 'build/junction_y7296/candidate.gds',
        'base_shapes': 'build/junction_y7296/net_shapes.json',
        'track_x_um': 437.4,
        'low_y_um': 910.8,
        'high_y_um': 1028.6,
    },
