...
# Fresh namespace from config_base, all design values assigned before finalization.
PLACE_BALANCE_TOL = 0.08
PLACE_FILL_MODE = 'alternate'
ROUTING_KNOBS = {'PRL_MIN_PINS': 5, 'SPAN_LANE_PACK': False}
