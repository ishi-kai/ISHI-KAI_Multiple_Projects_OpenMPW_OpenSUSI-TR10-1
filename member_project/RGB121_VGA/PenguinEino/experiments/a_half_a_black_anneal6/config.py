...
SYN_TB_RTL = ['/home/ishi-kai/ishi-vga/experiments/a_half_a128_black/tests/tb_rtl.v']
SYN_TB_NET = []
BUFTH_NETS = ['clk']
STA_CLK_PORT = 'clk'
STA_PERIOD_NS = 155.0
...
HALF_SLOT = {'art': 'A', 'scale': 4, 'h_start': 63, 'h_end': 120, 'h_bits': 8, 'v_start': 500, 'v_last': 0, 'horizontal_total': 200, 'palette_rgb111': [7, 3, 4, 3, 1, 5], 'signals': 6, 'including_vdd_excluding_common_vss': 7, 'target_bbox_um': [1800, 900], 'adopted': False, 'reset': False, 'background': 'black', 'source': 'a_half_a128_5col'}
ROW_OPT = {'source': 'a_half_a_black_phys6', 'restarts': 8, 'steps_per_restart': 2000000, 'seed': 11, 'temperature_start': 4.0, 'temperature_end': 0.02, 'spread_weight': 0, 'order_passes': 80, 'max_width_average_factor': 1.025}
finalize(globals())
