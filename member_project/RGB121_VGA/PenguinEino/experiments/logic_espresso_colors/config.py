"""Exact-image combinational experiment: logic_espresso_colors."""
...
SYN_RTL = [str(PROJECT/'rtl/ishi_vga_core.v'), str(PROJECT/'experiments/logic_espresso_colors/ishi_logo.v')]
