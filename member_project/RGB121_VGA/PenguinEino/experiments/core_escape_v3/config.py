...
CORE_ESCAPE = {'top': 'ishi_vga_core',
 'source_gds': 'experiments/core_ports_final/build/labeled_core.gds',
 'source_sha256': '3948145e00ad30fde2b0843e99b57dc275473ea02cc3441e15a5c27802a1b84c',
 'actual_pins': 'experiments/core_route_audit/build/audit/actual_pin_map.json',
 'placement': 'experiments/phys_desc5/layout/placement.json',
 'bounds_um': [-14.4, 1.8, 1780.2, 1762.2],
 'grid_um': 0.9,
 'max_expanded_nodes': 8000000,
 'via_cost_steps': 12,
 'terminal_layers': ['M1', 'M2'],
 'max_core_size_um': [1800, 1800],
 'ports': [{'net': 'r[1]', 'edge': 'BOTTOM'},
           {'net': 'r[0]', 'edge': 'BOTTOM'},
           {'net': 'g[0]', 'edge': 'BOTTOM'},
           {'net': 'b[0]', 'edge': 'BOTTOM', 'terminal_layers': ['M1', 'M2']},
           {'net': 'vsync', 'edge': 'RIGHT'},
           {'net': 'g[1]', 'edge': 'RIGHT'},
           {'net': 'hsync', 'edge': 'RIGHT'},
           {'net': 'b[1]', 'edge': 'RIGHT'},
           {'net': 'reset_n', 'edge': 'TOP'},
           {'net': 'clk', 'edge': 'TOP'}]}
