...
POLY_TRIAL = {'source_design': 'experiments/phys_desc5', 'input_gds': 'build/postrepair_compacted.gds', 'input_shapes': 'build/postrepair_shapes.json', 'input_pins': 'build/postrepair_pins.json', 'net': '_079_', 'shape_index': 1, 'contacts_x_um': [1053.0, 1080.0], 'detour_y_offset_um': 2.7, 'gc_width_multiple_of_min': 1}
