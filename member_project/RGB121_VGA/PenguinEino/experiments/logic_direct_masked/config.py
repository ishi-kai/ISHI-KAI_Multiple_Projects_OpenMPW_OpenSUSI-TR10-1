"""Exact-image combinational experiment: logic_direct_masked."""
...
SYN_RTL = [str(PROJECT/'rtl/ishi_vga_core.v'), str(PROJECT/'experiments/logic_direct_masked/ishi_logo.v')]
