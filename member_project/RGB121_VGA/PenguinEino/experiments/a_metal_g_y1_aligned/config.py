...
SYN_TB_RTL = ['/home/ishi-kai/ishi-vga/experiments/a_metal_g_y1_aligned/tests/tb_rtl.v']
SYN_TB_NET = []
BUFTH_NETS = ['clk']
STA_CLK_PORT = 'clk'
STA_PERIOD_NS = 310.0
