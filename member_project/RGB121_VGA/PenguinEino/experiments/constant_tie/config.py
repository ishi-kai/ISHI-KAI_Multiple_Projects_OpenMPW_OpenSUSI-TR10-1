...
CONSTANT_TIE = {'input_gds': 'experiments/phys_desc5/build/postrepair_compacted.gds', 'actual_pins': 'experiments/routing_audit/actual_pin_map.json', 'placement': 'experiments/phys_desc5/layout/placement.json', 'instance': '_542_', 'pin': 'D', 'literal': "1'h1", 'rail': 'vdd', 'search_x_tracks': 8, 'search_y_offsets_um': [-3.4, -5.4, -8.1, -10.8, 3.4, 5.4, 8.1, 10.8], 'top_channel_y_um': 1758.6}
