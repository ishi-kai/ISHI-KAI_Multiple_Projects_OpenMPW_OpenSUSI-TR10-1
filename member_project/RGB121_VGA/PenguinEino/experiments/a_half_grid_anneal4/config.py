...
SYN_TB_RTL = ['/home/ishi-kai/ishi-vga/experiments/a_half_grid64/tests/tb_rtl.v']
SYN_TB_NET = []
BUFTH_NETS = ['clk']
STA_CLK_PORT = 'clk'
STA_PERIOD_NS = 310.0
...
HALF_SLOT = {'art': 'new grid redraw, shared I; not exact A/B', 'scale': 8, 'h_start': 71, 'h_end': 100, 'h_bits': 7, 'v_start': 500, 'v_last': 0, 'horizontal_total': 100, 'signals': 6, 'including_vdd_excluding_common_vss': 7, 'target_bbox_um': [1800, 900], 'adopted': False, 'reset': False}
ROW_OPT = {'source': 'a_half_grid_phys4', 'restarts': 8, 'steps_per_restart': 2000000, 'seed': 11, 'temperature_start': 4.0, 'temperature_end': 0.02, 'spread_weight': 0, 'order_passes': 80, 'max_width_average_factor': 1.025}
finalize(globals())
