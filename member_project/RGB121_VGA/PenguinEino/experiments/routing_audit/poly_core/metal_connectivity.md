...
GDS `experiments/poly_core/build/poly_core_trial.gds`; 421 actual placed instances matched, 987 signal pins labeled from v59_4 LEF and GDS transforms.

Actual short components: **14**; transitive within-component net pairs: **143**; directly overlapping routed net pairs: **23**. Source map points: {'on_same_pin_component_route_anchor': 1017}. Unlocated route-map shapes: 1.
...
### 5. Nets _027_, _033_, _038_, _162_, _194_, _211_, _213_, _227_, _246_, hsync
BBox [263.9, 70.5, 1721.6, 1749.8] µm; mapped crossing candidates 10; pins 45.
...
- Candidate local M2 edit window: [261.2, 67.8, 1724.3, 1752.5] µm (diagnostic bbox expansion, not a repair recommendation).
