...
ROUTING_KNOBS = {'PRL_MIN_PINS': 10, 'SPAN_LANE_PACK': True}
...
ROW_OPT = {'source': 'a_metal_g_power_phys4', 'restarts': 8, 'steps_per_restart': 2000000, 'seed': 11, 'temperature_start': 4.0, 'temperature_end': 0.02, 'spread_weight': 0, 'order_passes': 80, 'max_width_average_factor': 1.025}
ROW_OPT = {'source': 'a_metal_g_power_anneal4', 'restarts': 32, 'steps_per_restart': 4000000, 'seed': 37, 'temperature_start': 4.0, 'temperature_end': 0.02, 'spread_weight': 0, 'order_passes': 80, 'max_width_average_factor': 1.025}
POWER_LAYOUT = {'source': 'a_power_opt4', 'order_seed': 101, 'order_passes': 120, 'sites': 328, 'target_um': [1800, 900], 'adopted_art': 'g_power', 'frame_integration': False}
finalize(globals())
