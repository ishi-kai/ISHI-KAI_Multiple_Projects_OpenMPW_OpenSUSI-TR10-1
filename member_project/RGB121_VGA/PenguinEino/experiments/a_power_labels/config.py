...
SYN_TB_RTL = ['/home/ishi-kai/ishi-vga/experiments/a_metal_g_power/tests/tb_rtl.v']
SYN_TB_NET = []
BUFTH_NETS = ['clk']
STA_CLK_PORT = 'clk'
STA_PERIOD_NS = 310.0
...
HALF_SLOT = {'art': 'new grid redraw, shared I; not exact A/B', 'scale': 8, 'h_start': 71, 'h_end': 100, 'h_bits': 7, 'v_start': 500, 'v_last': 0, 'horizontal_total': 100, 'signals': 6, 'including_vdd_excluding_common_vss': 7, 'target_bbox_um': [1800, 900], 'adopted': False, 'reset': False, 'background': 'black', 'source': 'a_half_grid64', 'proposal': 'g_power', 'title': '格子+5：電源への枝', 'base': 'grid', 'added_nets': ['VDD', 'VSS'], 'added_segments': 5, 'article': 'https://note.com/akira_tsuchiya/n/n0c720b3498b4', 'palette_rgb111': [0, 3, 4, 3, 1, 5], 'grid_n_diff_split': True, 'drawing_not_extracted_cmos': True}
ROW_OPT = {'source': 'a_metal_g_power_phys4', 'restarts': 8, 'steps_per_restart': 2000000, 'seed': 11, 'temperature_start': 4.0, 'temperature_end': 0.02, 'spread_weight': 0, 'order_passes': 80, 'max_width_average_factor': 1.2}
ROW_OPT = {'source': 'a_metal_g_power_anneal4', 'restarts': 24, 'steps_per_restart': 4000000, 'seed': 91, 'temperature_start': 4.0, 'temperature_end': 0.02, 'spread_weight': 0, 'order_passes': 80, 'max_width_average_factor': 1.2}
CORE_PORT_LABELS = {'top': 'ishi_vga_core', 'source_gds': 'experiments/a_power_fix172eq/build/candidate.gds', 'source_sha256': 'ae88a6cf4a9e0242afa88a12882a5c372ca9492b0e6a3eb15598ab9d2fa606ae', 'actual_pin_map': 'experiments/a_power_flex4/build/audit/actual_pin_map.json', 'actual_pin_map_sha256': 'c02093a4666091ed3c00c61878f8508f2efc7cda27dd7fe304c932074d6929f3', 'placement': 'experiments/a_power_flex4/layout/placement.json', 'placement_sha256': '9bb14d39620bfcf46904af14cafc9b22ff23da51b21e8e6e4734b5b092847f0f', 'reference_spice': 'experiments/a_power_flex4/build/ishi_vga_core.spice', 'reference_spice_sha256': '075c085c4149a66e548237f5b19f2d0a0eafa1736cd508ea1ec3cf0c9c1881da', 'expected_ports': ['b', 'clk', 'g', 'hsync', 'r', 'vsync', 'vdd', 'vss']}
finalize(globals())
