...
SYN_TB_RTL = ['/home/ishi-kai/ishi-vga/experiments/a_metal_b_outputs/tests/tb_rtl.v']
SYN_TB_NET = []
BUFTH_NETS = ['clk']
STA_CLK_PORT = 'clk'
STA_PERIOD_NS = 155.0
...
HALF_SLOT = {'art': 'B', 'scale': 4, 'h_start': 79, 'h_end': 136, 'h_bits': 8, 'v_start': 500, 'v_last': 0, 'horizontal_total': 200, 'palette_rgb111': [0, 3, 4, 3, 1, 5], 'signals': 6, 'including_vdd_excluding_common_vss': 7, 'target_bbox_um': [1800, 900], 'adopted': False, 'reset': False, 'background': 'black', 'source': 'a_half_b128_5col', 'proposal': 'b_outputs', 'title': 'B+8：3つの出力', 'base': 'B', 'added_nets': ['Y1', 'Y2', 'Y3'], 'added_segments': 8, 'article': 'https://note.com/akira_tsuchiya/n/n0c720b3498b4', 'grid_n_diff_split': False, 'drawing_not_extracted_cmos': True}
finalize(globals())
