#!/usr/bin/env python3
"""Check descending_* RTL and post-BUFTH netlists at both target clocks."""
...
names = sys.argv[1:] or ('descending_h159','descending_h199','descending_h255',
                        'descending_h79','descending_h79_v500')
for name in names:
    if not name.startswith('descending_') or '/' in name:
        raise SystemExit('Expected a descending_* experiment name')
