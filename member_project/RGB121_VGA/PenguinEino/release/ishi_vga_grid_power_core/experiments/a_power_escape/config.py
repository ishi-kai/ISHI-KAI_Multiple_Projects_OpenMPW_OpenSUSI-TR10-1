...
CORE_ESCAPE = {'top': 'ishi_vga_core', 'source_gds': 'experiments/a_power_labels/build/labeled_core.gds', 'source_sha256': '5a464e53d90307e510aeb3e8113941caa135f34427a8500f672f9f0746913c80', 'actual_pins': 'experiments/a_power_flex4/build/audit/actual_pin_map.json', 'placement': 'experiments/a_power_flex4/layout/placement.json', 'bounds_um': [-14.4, 1.8, 1780.2, 895.5], 'grid_um': 0.9, 'max_expanded_nodes': 8000000, 'via_cost_steps': 12, 'terminal_layers': ['M2'], 'max_core_size_um': [1800, 900], 'ports': [{'net': 'hsync', 'edge': 'BOTTOM'}, {'net': 'r', 'edge': 'LEFT'}, {'net': 'g', 'edge': 'LEFT'}, {'net': 'b', 'edge': 'LEFT'}, {'net': 'vsync', 'edge': 'TOP'}, {'net': 'clk', 'edge': 'TOP'}]}
finalize(globals())
