...
C {IP62LIB/MN.sym} -720 -130 0 0 {name=XMDMYN1 model=NMOS w=4.8u l=5u m=4 as=7.2p ad=7.2p ps=7.8u pd=7.8u nrd=0 nrs=0}
C {devices/lab_wire.sym} -740 -80 0 0 {name=p26 sig_type=std_logic lab=VSS}
C {IP62LIB/MP.sym} -720 -250 0 0 {name=XMDMYP1 model=PMOS w=13.2u l=5u m=8 as=19.8p ad=19.8p ps=16.2u pd=16.2u nrd=0 nrs=0}
C {devices/lab_wire.sym} -740 -300 0 0 {name=p10 sig_type=std_logic lab=VDD}
C {devices/opin.sym} 740 -1180 0 0 {name=p1 lab=BPO}
C {devices/opin.sym} 740 -1000 0 0 {name=p3 lab=BPI}
C {devices/opin.sym} 740 -200 0 0 {name=p8 lab=BNI}
C {devices/opin.sym} 740 -20 0 0 {name=p9 lab=BNO}
C {devices/opin.sym} 740 -820 0 0 {name=p5 lab=BPF}
C {devices/opin.sym} 740 -380 0 0 {name=p6 lab=BNF}
