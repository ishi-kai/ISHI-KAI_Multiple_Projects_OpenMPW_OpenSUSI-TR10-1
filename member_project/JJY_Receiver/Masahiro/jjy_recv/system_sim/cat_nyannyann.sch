...
C {devices/code_shown.sym} -225 -425 0 0 {name=s1 only_toplevel=false value="""
...
set units = d
save all
#save XTALN XTALP VXON VXOP VOUT VSPEAKER i(VDD) i(VDDBUF)
...
C {OBUF_SSF.sym} 1160 390 0 0 {name=x1}
