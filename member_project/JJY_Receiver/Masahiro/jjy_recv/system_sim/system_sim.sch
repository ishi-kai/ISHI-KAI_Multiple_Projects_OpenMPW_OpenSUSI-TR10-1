...
N 840 140 900 140 {lab=0}
N 850 -10 900 -10 {lab=out}
N 20 50 20 140 {lab=0}
N 120 60 120 140 {lab=0}
N 170 40 170 140 {lab=0}
N 260 30 260 140 {lab=0}
N 300 40 300 140 {lab=0}
N 360 30 360 70 {lab=lo}
N 360 30 410 30 {lab=lo}
N 360 130 360 140 {lab=0}
N 430 30 430 140 {lab=0}
N 590 60 590 140 {lab=0}
N 660 60 660 140 {lab=0}
N 700 40 700 120 {lab=0}
N 900 60 900 140 {lab=0}
...
C {devices/gnd.sym} 70 160 0 0 {name=l2 lab=0}
...
+ VT=2.5 VH=0.01
+ RON=0.01 ROFF=10G "}
C {devices/vsource.sym} 360 100 0 0 {name=V1 value="sin(2.5 2.5 38k)" savecurrent=false}
...
C {devices/lab_pin.sym} 360 50 0 0 {name=p6 sig_type=std_logic lab=lo}
