...
C {gilbert_cell.sym} 740 250 0 0 {name=x1}
...
C {devices/vsource.sym} 20 470 0 0 {name=VINp value="DC 2.5 AC 1 sin(2.5 10m 40k 0 0 0)" savecurrent=false}
...
C {devices/vsource.sym} 240 470 0 0 {name=VINn value="DC 2.5 sin(2.5 10m 40k 0 0 180)" savecurrent=false}
...
C {devices/vsource.sym} 20 630 0 0 {name=VINp1 value="DC 2.5 AC 1 sin(2.5 1V 40k 0 0 90)" savecurrent=false}
C {devices/gnd.sym} 20 660 0 0 {name=l6 lab=0}
C {devices/vsource.sym} 240 630 0 0 {name=VINn1 value="DC 2.5 sin(2.5 1V 40k 0 0 270)" savecurrent=false}
