...
N 120 -120 120 -80 {
lab=GND}
N 330 -170 390 -170 {lab=out}
N 260 -270 260 -190 {lab=in}
N 260 -130 260 -80 {lab=GND}
...
C {devices/vsource.sym} 260 -160 0 0 {name=Vinp value="sin 2.5 2.5 40k"}
C {opamp_test.sym} 390 -300 0 0 {name=X1}
