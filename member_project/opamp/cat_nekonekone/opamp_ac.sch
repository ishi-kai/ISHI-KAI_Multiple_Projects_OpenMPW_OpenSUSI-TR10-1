...
C {devices/code_shown.sym} -470 -80 0 0 {name=measure only_toplevel=false value="
.measure ac gain_1kHz find vdb(out) at=1e3
.measure ac fc when vdb(out)=0
.measure ac phase_fc find vp(out) when vdb(out)=0
.measure ac PM param="phase_fc+180""}
...
spice_ignore=false}
C {opamp_test.sym} 350 -280 0 0 {name=X1}
