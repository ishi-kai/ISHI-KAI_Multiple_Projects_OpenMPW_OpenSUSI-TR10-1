...
N -760 10 -760 50 {lab=VB}
N -170 -280 -110 -280 {lab=VOUT}
N -390 -300 -320 -300 {lab=#net1}
N -390 -320 -360 -320 {lab=VB}
N -760 -300 -690 -300 {lab=#net2}
N -760 -160 -320 -160 {lab=#net2}
N -320 -300 -320 -220 {lab=#net1}
...
C {devices/lab_pin.sym} -760 10 0 1 {name=l12 sig_type=std_logic lab=VB}
...
device=resistor
m=1}
C {devices/lab_wire.sym} -360 -320 0 1 {name=p2 sig_type=std_logic lab=VB}
...
C {devices/vsource.sym} -760 80 0 0 {name=V1 value="dc 3.5" savecurrent=false}
