...
N -400 40 -370 40 {lab=VB1}
N -400 120 -370 120 {lab=VIN}
N -400 160 -370 160 {lab=VOUT}
...
N -60 60 -60 80 {lab=VB1}
N -400 80 -370 80 {lab=VB2}
C {devices/lab_pin.sym} -80 -100 0 1 {name=l6 sig_type=std_logic lab=VDD}
C {devices/lab_pin.sym} -100 70 0 0 {name=l1 sig_type=std_logic lab=VSS}
C {devices/lab_pin.sym} -40 80 0 1 {name=l2 sig_type=std_logic lab=VB2}
...
C {devices/ipin.sym} -400 120 0 0 {name=p3 lab=VIN}
C {devices/opin.sym} -400 160 0 1 {name=p4 lab=VOUT}
C {devices/iopin.sym} -400 -40 0 1 {name=p5 lab=VSS}
C {devices/iopin.sym} -400 0 0 1 {name=p6 lab=VREF}
C {devices/ipin.sym} -400 40 0 0 {name=p7 lab=VB1}
...
C {devices/lab_pin.sym} -370 40 0 1 {name=l11 sig_type=std_logic lab=VB1}
C {devices/lab_pin.sym} -370 120 0 1 {name=l12 sig_type=std_logic lab=VIN}
C {devices/lab_pin.sym} -370 160 0 1 {name=l13 sig_type=std_logic lab=VOUT}
...
spiceprefix=D
m=4}
C {devices/lab_pin.sym} -60 80 0 0 {name=l16 sig_type=std_logic lab=VB1}
C {devices/lab_pin.sym} -370 80 0 1 {name=l17 sig_type=std_logic lab=VB2}
C {devices/ipin.sym} -400 80 0 0 {name=p8 lab=VB2}
