...
N 140 -340 220 -340 {lab=#net3}
N 180 -290 220 -290 {lab=#net3}
N 60 -290 140 -290 {lab=VSS}
N 60 -290 60 -220 {lab=VSS}
N 60 -220 140 -220 {lab=VSS}
N 220 -340 220 -290 {lab=#net3}
N 140 -360 140 -320 {lab=#net3}
N 60 -390 140 -390 {lab=VSS}
N 60 -390 60 -290 {lab=VSS}
N 180 -390 200 -390 {lab=#net2}
N 200 -460 200 -390 {lab=#net2}
N 200 -510 200 -460 {lab=#net2}
