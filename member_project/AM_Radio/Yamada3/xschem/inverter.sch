...
C {MP.sym} 20 -50 0 0 {name=M1 model=PMOS w=30u l=5u nrd=0 nrs=0 m=1 spiceprefix=X}
C {MN.sym} 20 50 0 0 {name=M2 model=NMOS w=10u l=5u nrd=0 nrs=0 m=1 spiceprefix=X}
