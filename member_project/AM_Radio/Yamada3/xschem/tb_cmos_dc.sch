...
node=gmid_pmos
y2=0}
B 2 640 0 1440 400 {flags=graph
ypos1=0
ypos2=2
divy=5
subdivy=8
...
y2=10
y1=6}
B 2 1480 0 2280 400 {flags=graph
ypos1=0
ypos2=2
divy=5
subdivy=8
...
C {devices/code_shown.sym} 2345 -1730 0 0 {name=control only_toplevel=false value=".option savecurrent
.param nmos_w = 10u
.control
save all
# DC analysis
...
let rout_nmos=abs(v(vdd)/i(vmeas_nmos))
let rout_pmos=abs(v(vdd)/i(vmeas_pmos))
show
print @m.xm1.m1[vth]
print @m.xm2.m1[vth]
write tb_cmos_dc.raw all
.endc"}
