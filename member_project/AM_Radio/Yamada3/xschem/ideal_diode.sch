...
C {cascode_opamp.sym} -80 0 0 0 {name=x1}
...
C {devices/lab_pin.sym} 100 30 2 1 {name=p2 sig_type=std_logic lab=opout}
...
C {devices/lab_pin.sym} 270 0 0 1 {name=l7 sig_type=std_logic lab=VOUT}
