...
N -180 -60 -160 -60 {lab=#net1}
N -180 -60 -180 60 {lab=#net1}
N -180 60 -160 60 {lab=#net1}
N -120 -110 -120 -90 {lab=VDD}
N -120 90 -120 120 {lab=GND}
N -120 0 0 0 {lab=VOUT}
N -230 170 -170 170 {lab=#net1}
N -230 0 -230 170 {lab=#net1}
...
N -250 0 -230 0 {lab=#net1}
N -230 0 -180 0 {lab=#net1}
N -360 0 -310 0 {lab=VIN}
N -230 230 -170 230 {lab=#net1}
N -230 170 -230 230 {lab=#net1}
N -70 170 -70 230 {lab=VOUT}
N -110 230 -70 230 {lab=VOUT}
...
device=resistor
m=1}
C {devices/res.sym} -280 0 3 1 {name=R1
value=5k
footprint=1206
device=resistor
m=1}
C {devices/capa.sym} -140 230 3 1 {name=C4
m=1
value=8p
footprint=1206
