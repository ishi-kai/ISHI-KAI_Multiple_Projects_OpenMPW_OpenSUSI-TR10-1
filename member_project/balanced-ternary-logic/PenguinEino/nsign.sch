...
N 0 -430 120 -430 {lab=V+}
N 120 -430 120 -170 {lab=V+}
N 0 -350 120 -350 {lab=V+}
N 0 -170 120 -170 {lab=V+}
N -240 -350 -40 -350 {lab=a}
N -240 -170 -40 -170 {lab=b}
N 0 10 0 110 {lab=vout}
N 20 -20 160 -20 {lab=V+}
N 20 140 160 140 {lab=V+}
N 0 170 0 250 {lab=#net3}
N 0 310 0 430 {lab=#net4}
N 0 490 0 580 {lab=V-}
N 0 280 120 280 {lab=V-}
N 120 280 120 540 {lab=V-}
N 0 460 120 460 {lab=V-}
N 0 540 120 540 {lab=V-}
...
N 470 140 550 140 {lab=V+}
N 770 140 850 140 {lab=V+}
N 470 320 550 320 {lab=V-}
N 770 320 850 320 {lab=V-}
...
nrd=0
nrs=0}
C {devices/iopin.sym} 0 -490 0 0 {name=l1 lab=V+}
...
C {devices/lab_pin.sym} 160 -20 0 1 {name=lab4 lab=V+}
C {devices/lab_pin.sym} 160 140 0 1 {name=lab5 lab=V+}
...
C {devices/iopin.sym} 0 580 2 0 {name=l4 lab=V-}
...
nrd=0
nrs=0}
C {devices/iopin.sym} 470 440 0 0 {name=gload lab=V0}
...
nrd=0
nrs=0}
C {devices/lab_pin.sym} 770 440 0 0 {name=gload1 lab=V0}
...
C {devices/lab_pin.sym} 550 140 0 1 {name=lab6 lab=V+}
C {devices/lab_pin.sym} 850 140 0 1 {name=lab7 lab=V+}
C {devices/lab_pin.sym} 550 320 0 1 {name=lab8 lab=V-}
C {devices/lab_pin.sym} 850 320 0 1 {name=lab9 lab=V-}
T {NSIGN / y = -sign(a+b) / zero clamp referenced to V0} -240 -620 0 0 0.35 0.35 {}
...
T {V0 = 0 V reference. No internal load capacitor.} 1030 -25 0 0 0.24 0.24 {}
