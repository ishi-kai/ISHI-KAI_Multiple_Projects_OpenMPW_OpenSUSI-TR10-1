...
F {}
E {}
T {NOR / y = -max(a,b) / DC + TRANSIENT} 40 -160 0 0 0.4 0.4 {}
T {DUT: nor.sym -> nor.sch / dimensions and wiring live in the cell} 40 -100 0 0 0.25 0.25 {}
T {27 C / V+ = +5 V / V- = -5 V / external Cload = 10 fF} 40 -55 0 0 0.25 0.25 {}
C {/home/ishi-kai/balanced-ternary-logic/nor.sym} 400 140 0 0 {name=x1}
...
T {  21 -   40          (0, -5)               +0                39} 1150 -17 0 0 0.23 0.23 {}
T {  41 -   60          (5, -5)               -5                59} 1150 21 0 0 0.23 0.23 {}
T {  61 -   80          (5, 0)                -5                79} 1150 59 0 0 0.23 0.23 {}
T {  81 -  100          (0, 0)                +0                99} 1150 97 0 0 0.23 0.23 {}
T { 101 -  120          (-5, 0)               +0                119} 1150 135 0 0 0.23 0.23 {}
T { 121 -  140          (-5, 5)               -5                139} 1150 173 0 0 0.23 0.23 {}
T { 141 -  160          (0, 5)                -5                159} 1150 211 0 0 0.23 0.23 {}
...
value=".temp 27
.options rshunt=1e12
BEXPECTED expected 0 V=-max(v(a),v(b))
...
plot v(a) v(vout) v(expected) ylimit -5.5 5.5 title 'NOR DC: sweep A, B = -5 V'
reset
alter VB 0
dc VA -5 5 0.015625
...
plot v(a) v(vout) v(expected) ylimit -5.5 5.5 title 'NOR DC: sweep A, B = 0 V'
reset
alter VB 5
dc VA -5 5 0.015625
...
plot v(a) v(b) v(vout) v(expected) ylimit -5.5 5.5 title 'NOR: A, B and output / all nine input pairs'
if const.failures = 0
echo PASS: all DC and transient samples within expected +/-0.5V
else
echo FAIL: NOR truth-table samples outside tolerance
