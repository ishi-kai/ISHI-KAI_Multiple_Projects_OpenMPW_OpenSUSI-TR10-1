...
C {mul.sym} 330 340 0 0 {name=x_mul}
C {full_adder.sym} 800 340 0 0 {name=x_fa}
...
C {inverter.sym} 330 550 0 0 {name=x_and}
...
C {inverter.sym} 330 710 0 0 {name=x_or1}
...
C {inverter.sym} 800 710 0 0 {name=x_or2}
