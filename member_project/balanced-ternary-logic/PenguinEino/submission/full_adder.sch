...
C {half_adder.sym} 300 160 0 0 {name=x_ha1}
C {half_adder.sym} 800 160 0 0 {name=x_ha2}
C {nany.sym} 650 600 0 0 {name=x_cmerge}
C {inverter.sym} 950 600 0 0 {name=x_cout}
