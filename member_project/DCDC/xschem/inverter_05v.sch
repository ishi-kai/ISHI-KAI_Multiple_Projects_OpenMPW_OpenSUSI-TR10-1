...
C {MP.sym} 0 0 0 0 {name=M1 model=PMOS w=10u l=2u nrd=0 nrs=0 m=1 spiceprefix=X}
C {MN.sym} 0 100 0 0 {name=M2 model=NMOS w=10u l=1u nrd=0 nrs=0 m=5 spiceprefix=X}
