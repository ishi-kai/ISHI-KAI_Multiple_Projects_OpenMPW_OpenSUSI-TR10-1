...
C {MP.sym} 70 -120 0 0 {name=M5 model=PMOS w=25u l=2u nrd=0 nrs=0 m=1 spiceprefix=X}
...
C {MP.sym} 320 -120 0 0 {name=M6 model=PMOS w=25u l=2u nrd=0 nrs=0 m=5 spiceprefix=X}
C {MN.sym} 320 100 0 0 {name=M7 model=NMOS w=10u l=2u nrd=0 nrs=0 m=5 spiceprefix=X}
C {devices/opin.sym} 380 0 0 0 {name=p6 lab=out}
C {MP.sym} -40 -120 0 1 {name=M8 model=PMOS w=25u l=2u nrd=0 nrs=0 m=1 spiceprefix=X}
C {devices/iopin.sym} -80 -40 1 0 {name=p3 lab=ib}
C {TR-1umLIB/CSIO.sym} 340 50 1 1 {name=XC1
model=F_CSIO
spiceprefix=X
x=120u
y=120u
