...
N 930 60 930 120 {lab=out}
N 790 40 790 50 {lab=#net7}
N 340 40 790 40 {lab=#net7}
N 340 40 340 180 {lab=#net7}
N 340 240 880 240 {lab=GND}
N 790 210 790 240 {lab=GND}
N 860 60 930 60 {lab=out}
N 860 180 930 180 {lab=#net8}
...
C {devices/lab_pin.sym} 930 60 0 1 {name=p1 sig_type=std_logic lab=out}
...
C {devices/capa.sym} 930 150 0 0 {name=C2
m=1
value=220p
footprint=1206
device="ceramic capacitor"}
